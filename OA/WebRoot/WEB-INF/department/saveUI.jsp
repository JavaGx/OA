...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="%{id==null?'department_add.action':'department_edit.action'}" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td width="100">上级部门</td>
                        <td><s:select name="parentId" list="#list" headerKey="" headerValue="==请选择部门==" listKey="%{id}" listValue="%{name}" cssClass="SelectStyle">
                            </s:select>
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
