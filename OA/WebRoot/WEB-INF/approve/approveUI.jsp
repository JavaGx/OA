    ...
    <script type="text/javascript">
    	$().ready(function(){
    		$("#agree").click(function(){
    			$(document.forms[0]).append("<input type='hidden' name='isApprove' value='同意'/>");
    			document.forms[0].submit();
    		})
    		$("#disagree").click(function(){
    			$(document.forms[0]).append("<input type='hidden' name='isApprove' value='不同意'/>");
    			document.forms[0].submit();
    		})
    	});
...
<div id=MainArea>
    <s:form action="approve_submit">
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="image" id="agree" src="${pageContext.request.contextPath}/style/blue/images/button/agree.png"/>
			<input type="image" id="disagree" src="${pageContext.request.contextPath}/style/blue/images/button/disagree.png"/>
