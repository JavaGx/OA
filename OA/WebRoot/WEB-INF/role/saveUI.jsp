...
<div id="MainArea">
    ...
    <s:form action="%{id==0?'role_add.action':'role_edit.action'}" method="post">
        ...
        <div id="InputDetailBar">
            ...
            <s:a href="javascript:history.go(-1);"><img src="${pageContext.request.contextPath}/style/images/goBack.png"/></s:a>
        </div>
    </s:form>
</div>
