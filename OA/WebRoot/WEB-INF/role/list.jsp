        ...
        <tbody id="TableData" class="dataContainer" datakey="roleList">
        	<s:iterator value="#list">
				<tr class="TableDetail1 template">
					<td>${name}&nbsp;</td>
					<td>${description}&nbsp;</td>
					<td><s:a action="role_delete?id=%{id}" onclick="return delConfirm('你确定要删除吗？')">删除</s:a>
						<s:a action="role_editUI?id=%{id}">修改</s:a>
						<a target="right" href="${pageContext.request.contextPath}/role_setPrivilegeUI.action?id=${id}">设置权限</a>
					</td>
				</tr>
			</s:iterator>
        </tbody>
