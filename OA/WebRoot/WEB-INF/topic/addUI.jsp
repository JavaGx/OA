...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="topic_add.action" style="margin: 0; padding: 0;">
	<s:hidden name="forumId" value="%{forumId}"></s:hidden>
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<s:a action="topic_list?forumId=%{forumId}"><s:property value="#forum.name"/></s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				发表新主题
			</div>
		</div>
